...
1. Run the site: `docker run -d --name graphing-calculator -p 8080:80 ti-84`
2. Open <http://localhost:8080> (TI-84) and <http://localhost:8080/graphing.html> (Graphing Calculator Online).
